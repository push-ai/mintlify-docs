...
1. For Account, enter your Snowflake account. Usually, this is in the format ```<identifier>.<region>.<cloud provider>```, e.g. abc123.us-east-2.aws). See the [the Snowflake docs](https://docs.snowflake.com/en/user-guide/admin-account-identifier.html) for more information.
