...
Follow our setup guide to connect your MySQL data warehouse to Push.ai.

### Prerequisites

To connect MySQL to Push.ai, you need the following:

- A MySQL account with the appropriate permissions to create a user.
...
3. Click **Test MySQL** to confirm the connection settings.

4. Click **Connect MySQL** to complete the connection.
