...
<Accordion title="Job appointment summary">
...
<Accordion title="List of calendars for the location">
...
<Accordion title="Update company representative">
...
<Accordion title="List of contact types related to the company">
...
<Accordion title="Add job appointment">
