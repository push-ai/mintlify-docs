...
<Accordion title="Post comment to workspace">
...
<Accordion title="Create new object endpoint">
...
<Accordion title="Create new lists with access control">
...
<Accordion title="Add select option attribute">
...
<Accordion title="Create task with related records">
...
<Accordion title="Delete comment by id">
...
<Accordion title="Post status attributes update">
...
<Accordion title="Create note with parent info">
...
<Accordion title="Create webhook subscriptions">
...
<Accordion title="Update object records via values">
...
<Accordion title="Create object records via post">
...
<Accordion title="Create list entry with parent record">
...
<Accordion title="Update list entry via put">
...
<Accordion title="Create attribute">
...
<Accordion title="Delete entry from list">
...
<Accordion title="Delete record from object">
...
<Accordion title="Delete note by id">
...
<Accordion title="Fetch object by id">
...
<Accordion title="Retrieve list details">
...
<Accordion title="Retrieve workspace members">
...
<Accordion title="Update task details by id">
...
<Accordion title="Retrieve comment by id">
...
<Accordion title="Retrieve webhook details">
...
<Accordion title="Fetch entry details from list">
...
<Accordion title="Retrieve target attributes">
...
<Accordion title="Retrieve attribute by target and identifier">
...
<Accordion title="Patch object properties">
...
<Accordion title="Retrieve note by id">
...
<Accordion title="Patch list properties">
...
<Accordion title="Patch target identifier attribute configuration">
...
<Accordion title="Get notes endpoint">
...
<Accordion title="Retrieve attribute options">
...
<Accordion title="Get attribute values for entry in list">
...
<Accordion title="Query filtered list entries with sorting">
...
<Accordion title="Retrieve list of objects">
...
<Accordion title="Retrieve object record by id">
...
<Accordion title="Fetch attribute statuses">
...
<Accordion title="Retrieve thread details">
...
<Accordion title="Retrieve self information">
...
<Accordion title="Patch attribute option">
...
<Accordion title="Update entry values in list">
...
<Accordion title="Get record entry by id">
...
<Accordion title="List threads v2">
...
<Accordion title="Retrieve workspace member details">
...
<Accordion title="Patch status attributes">
...
<Accordion title="Get attribute value records">
...
<Accordion title="Query object records with filter and sort">
...
<Accordion title="Update list entry attributes">
...
<Accordion title="Update record data via object id">
