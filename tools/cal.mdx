...
<Accordion title="Cancel booking via uid">
...
<Accordion title="Check calendar version 2">
...
<Accordion title="Create membership for organization">
...
<Accordion title="Connect to calendar">
...
<Accordion title="Check gcal synchronization status">
...
<Accordion title="Confirm booking by uid">
...
<Accordion title="Check ics feed calendar endpoint">
...
<Accordion title="Create organization webhook by orgid">
...
<Accordion title="Create organization attributes">
...
<Accordion title="Add organization attribute option">
...
<Accordion title="Create oauth client user">
...
<Accordion title="Create oauth client webhook configuration">
...
<Accordion title="Check stripe status">
...
<Accordion title="Create phone call event">
...
<Accordion title="Create team membership with role">
...
<Accordion title="Create or update team profile">
...
<Accordion title="Create team in organization">
...
<Accordion title="Check team stripe integration status">
...
<Accordion title="Delete event type by id">
...
<Accordion title="Create phone call for event type">
...
<Accordion title="Create user availability schedule">
...
<Accordion title="Delete conference app connection">
...
<Accordion title="Create user schedule in organization">
...
<Accordion title="Add member to team using org and team id">
...
<Accordion title="Delete membership in team">
...
<Accordion title="Delete organization attribute">
...
<Accordion title="Delete oauth client webhook">
...
<Accordion title="Delete event type in team">
...
<Accordion title="Decline booking with reason">
...
<Accordion title="Create webhook for event type">
...
<Accordion title="Delete oauth client user">
...
<Accordion title="Delete organization attribute option">
...
<Accordion title="Create team event types with custom options">
...
<Accordion title="Create team event type">
...
<Accordion title="Delete team memberships by id">
...
<Accordion title="Delete user from organization">
...
<Accordion title="Delete webhooks for eventtype">
...
<Accordion title="Delete org webhook">
...
<Accordion title="Get stripe connect info">
...
<Accordion title="Get all timezones">
...
<Accordion title="Patch organization attribute option">
...
<Accordion title="Mark booking absent for uid">
...
<Accordion title="Modify org attribute by id">
...
<Accordion title="Get schedule for user in team">
...
<Accordion title="Delete selected calendars">
...
<Accordion title="Get available slots info">
...
<Accordion title="Modify organization membership by id">
...
<Accordion title="Patch organization user details">
...
<Accordion title="Delete organization membership">
...
<Accordion title="Post webhook event">
...
<Accordion title="Delete selected slot">
...
<Accordion title="Delete user attribute option">
...
<Accordion title="Retrieve booking details by uid">
...
<Accordion title="Reassign booking to another user">
...
<Accordion title="Reassign booking with uid">
...
<Accordion title="Retrieve calendar busy times">
...
<Accordion title="Delete user schedule">
...
<Accordion title="Retrieve event type by id">
...
<Accordion title="Retrieve my information">
...
<Accordion title="Retrieve membership from organization">
...
<Accordion title="Retrieve oauth client user by id">
...
<Accordion title="Retrieve organization webhook by id">
...
<Accordion title="Retrieve oauth client webhook by id">
...
<Accordion title="Post selected calendars">
...
<Accordion title="Retrieve calendar list">
...
<Accordion title="Refresh oauth token for client id">
...
<Accordion title="Retrieve provider details">
...
<Accordion title="Retrieve schedules list">
...
<Accordion title="Retrieve organization attributes">
...
<Accordion title="Retrieve current team for organization">
...
<Accordion title="Retrieve team event types">
...
<Accordion title="Reschedule booking by uid">
...
<Accordion title="Post user to organization">
...
<Accordion title="Retrieve team memberships for organization">
...
<Accordion title="Retrieve team memberships">
...
<Accordion title="Reserve slot for event">
...
<Accordion title="Delete team from organization">
...
<Accordion title="Patch team details by id">
...
<Accordion title="Get conference oauth authorization url">
...
<Accordion title="Retrieve team membership details">
...
<Accordion title="Retrieve default conferencing settings">
...
<Accordion title="Retrieve attribute options for org">
...
<Accordion title="Retrieve v2 conferencing info">
...
<Accordion title="Retrieve users in organization">
...
<Accordion title="Retrieve webhooks for event type">
...
<Accordion title="Retrieve team details in organization">
...
<Accordion title="Retrieve webhook details for oauth client">
...
<Accordion title="Save calendar ics feeds">
...
<Accordion title="Save oauth credentials via gcal api">
...
<Accordion title="Retrieve webhooks list">
...
<Accordion title="Retrieve organization attributes options">
...
<Accordion title="Save stripe details">
...
<Accordion title="Save calendar entry">
...
<Accordion title="Retrieve team membership by id">
...
<Accordion title="Retrieve organization webhooks by orgid">
...
<Accordion title="Set default conferencing app">
...
<Accordion title="Get teams list">
...
<Accordion title="Update destination calendar integration">
...
<Accordion title="Patch webhook event type">
...
<Accordion title="Post calendar credentials">
...
<Accordion title="Delete webhook for event type">
...
<Accordion title="Update oauth client webhook">
...
<Accordion title="Disconnect calendar using credential id">
...
<Accordion title="Get team information by teamid">
...
<Accordion title="Post org attribute option by user">
...
<Accordion title="Get team details by org id and team id">
...
<Accordion title="Post new booking request">
...
<Accordion title="Get google calendar oauth authentication url">
...
<Accordion title="Post conferencing app connect">
...
<Accordion title="Get event type by team id">
...
<Accordion title="Fetch event type details">
...
<Accordion title="Fetch all bookings">
...
<Accordion title="List team event types by org and team id">
...
<Accordion title="Fetch schedule by id">
...
<Accordion title="Get Organization ID">
Get the organization id of the user.
</Accordion>

<Accordion title="Fetch user schedule by org id">
...
<Accordion title="Fetch organization attribute by id">
...
<Accordion title="Get oauth clients user">
...
<Accordion title="Get organization teams event types">
...
<Accordion title="Get organization schedules">
...
<Accordion title="Get organization user schedules">
...
<Accordion title="Fetch provider access token">
...
<Accordion title="Get default schedule details">
...
<Accordion title="Handle conferencing oauth callback for app">
...
<Accordion title="Fetch webhook by eventtypeid">
...
<Accordion title="Update oauth client user settings">
...
<Accordion title="Force refresh user oauth client">
...
<Accordion title="Update webhook by id">
...
<Accordion title="Update webhook for organization">
...
<Accordion title="Update team membership properties">
...
<Accordion title="Update user profile details">
...
<Accordion title="Update team information by id">
...
<Accordion title="Update user schedule in organization">
...
<Accordion title="Update team membership by id">
