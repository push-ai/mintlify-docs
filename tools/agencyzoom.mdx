...
<Accordion title="Initiate dashboard data request">
...
<Accordion title="Batch create contacts">
...
<Accordion title="Batch create leads">
...
<Accordion title="Add note to lead">
...
<Accordion title="Create opportunity driver request">
...
<Accordion title="Batch delete tasks by id">
...
<Accordion title="Add opportunity data to lead">
...
<Accordion title="Delete customer by id">
...
<Accordion title="Delete customer file">
...
<Accordion title="Delete lead quote by id">
...
<Accordion title="Delete customer policy">
...
<Accordion title="Delete opportunity by id">
...
<Accordion title="Get certificate signing requests">
...
<Accordion title="Change lead status via leadid">
...
<Accordion title="Retrieve customer ams policies">
...
<Accordion title="Delete opportunity driver by id">
...
<Accordion title="Get authentication parameters via sso api">
...
<Accordion title="Add quote data to lead">
...
<Accordion title="Retrieve drivers by opportunity id">
...
<Accordion title="Delete vehicle opportunity by id">
...
<Accordion title="Retrieve loss reasons endpoint">
...
<Accordion title="Create opportunity vehicle">
...
<Accordion title="Assign groups endpoint">
...
<Accordion title="Retrieve locations list">
...
<Accordion title="Retrieve pipeline and stage information">
...
<Accordion title="Get lead source categories">
...
<Accordion title="Retrieve product lines listing">
...
<Accordion title="Retrieve vehicles for opportunity">
...
<Accordion title="Create business lead">
...
<Accordion title="List carriers via api">
...
<Accordion title="Fetch lead recycle events">
...
<Accordion title="Retrieve employee data">
...
<Accordion title="Access life professionals api">
...
<Accordion title="Post lead files request">
...
<Accordion title="Get lead sources">
...
<Accordion title="Customer search request">
...
<Accordion title="Retrieve notes for specific lead">
...
<Accordion title="Delete file from lead">
...
<Accordion title="Retrieve quotes for lead">
...
<Accordion title="Delete email thread">
...
<Accordion title="Lead create request">
...
<Accordion title="Create task post endpoint">
...
<Accordion title="Add opportunity data request">
...
<Accordion title="Retrieve end stages">
...
<Accordion title="Mark task as completed">
...
<Accordion title="Customer add note data request">
...
<Accordion title="Fetch custom fields metadata">
...
<Accordion title="Retrieve customer policies">
...
<Accordion title="Retrieve product categories list">
...
<Accordion title="Delete email thread message">
...
<Accordion title="Retrieve tasks for lead by leadid">
...
<Accordion title="Get text thread producer">
...
<Accordion title="Delete lead opportunity">
...
<Accordion title="List customer tasks">
...
<Accordion title="Search business classification request">
...
<Accordion title="Update user profile">
...
<Accordion title="Edit opportunity vehicle by id">
...
<Accordion title="Retrieve customer information">
...
<Accordion title="Get opportunity vehicle by id">
...
<Accordion title="Update lead business details">
...
<Accordion title="Retrieve opportunity by id">
...
<Accordion title="Delete text thread request">
...
<Accordion title="Link driver to opportunity">
...
<Accordion title="Search text thread messages details">
...
<Accordion title="Retrieve lead by leadid">
...
<Accordion title="Fetch lead opportunities by id">
...
<Accordion title="Update customer info using id">
...
<Accordion title="Lead status change via api">
...
<Accordion title="Retrieve driver opportunities by id">
...
<Accordion title="Reopen task with comments">
...
<Accordion title="Add tag to policy">
...
<Accordion title="Unlink driver from opportunity">
...
<Accordion title="Update lead data through leadid">
...
<Accordion title="Unlink vehicle from opportunity">
...
<Accordion title="Link vehicle to opportunity">
...
<Accordion title="Update task details with lead and customer ids">
...
<Accordion title="Mark email thread unread">
...
<Accordion title="Search email thread details">
...
<Accordion title="Post sso login request">
...
<Accordion title="User login request">
...
<Accordion title="Customer search request model">
...
<Accordion title="Edit opportunity driver request">
...
<Accordion title="Rename lead file">
...
<Accordion title="Mark thread unread via id">
...
<Accordion title="List email threads">
...
<Accordion title="Update lead opportunity info">
...
<Accordion title="Logout user endpoint">
...
<Accordion title="Update lead quote data">
...
<Accordion title="Lead pipeline count search request">
...
<Accordion title="Search thread notification request">
...
<Accordion title="Process lead sold request">
...
<Accordion title="Update policy by id">
...
<Accordion title="Service ticket list">
...
<Accordion title="Search and list tasks">
...
<Accordion title="Search life health leads">
...
<Accordion title="Post lead search request">
