...
<Accordion title="Copy course with specific options">
...
<Accordion title="Create adaptive release criteria by rule">
...
<Accordion title="Get oauth2 authorization code">
...
<Accordion title="Delete user from course">
...
<Accordion title="List gradebook columns for course">
...
<Accordion title="Get user gradebook for course">
...
<Accordion title="Copy course by courseid">
...
<Accordion title="Create course announcement">
...
<Accordion title="Retrieve course list">
...
<Accordion title="Create system announcement">
...
<Accordion title="Create assignment in course contents">
...
<Accordion title="Update user meeting attendance status">
...
<Accordion title="Create data source with external id">
...
<Accordion title="Add course content attachment">
...
<Accordion title="Create grading period in course gradebook">
...
<Accordion title="Update user criterion in adaptive rule">
...
<Accordion title="List course announcements">
...
<Accordion title="Create lti domain configuration">
...
<Accordion title="Create course group">
...
<Accordion title="Create discussion forum in course">
...
<Accordion title="Update user in course group">
...
<Accordion title="Post group attempts for gradebook column">
...
<Accordion title="Retrieve course details by id">
...
<Accordion title="Modify course content adaptive release group criteria">
...
<Accordion title="Update content group association">
...
<Accordion title="Create course content in course">
...
<Accordion title="Create course group in course">
...
<Accordion title="Update group details by course and group id">
...
<Accordion title="Post discussion message reply">
...
<Accordion title="Create institutional hierarchy node">
...
<Accordion title="Update course user details">
...
<Accordion title="Add new gradebook column for course">
...
<Accordion title="Retrieve course details">
...
<Accordion title="Update course information">
...
<Accordion title="Create new lti placement">
...
<Accordion title="Update course primary node association">
...
<Accordion title="Create calendar items">
...
<Accordion title="Post pronouns details">
...
<Accordion title="Add catalog category by type">
...
<Accordion title="Add adaptive release rule to course content">
...
<Accordion title="Post course assessment question">
...
<Accordion title="Create rubric association in course">
...
<Accordion title="Create rubric evaluation for course">
...
<Accordion title="Create course meeting">
...
<Accordion title="Get course announcement by id">
...
<Accordion title="Create course rubric with details">
...
<Accordion title="Create group set">
...
<Accordion title="Create term with availability and description">
...
<Accordion title="Update user observer">
...
<Accordion title="Create a new course">
...
<Accordion title="Update course category details">
...
<Accordion title="Post course message with bbml support">
...
<Accordion title="Add child node in hierarchy">
...
<Accordion title="Update child course in parent">
...
<Accordion title="Delete course by courseid">
...
<Accordion title="Post grade notation to course gradebook">
...
<Accordion title="Upload file to attempt in gradebook">
...
<Accordion title="Create course gradebook schema">
...
<Accordion title="Submit gradebook attempt">
...
<Accordion title="Create child content in course">
...
<Accordion title="Create group in course">
...
<Accordion title="Create new user profile">
...
<Accordion title="Update course information by courseid">
...
<Accordion title="Create a class course">
...
<Accordion title="Update institutional hierarchy user node">
...
<Accordion title="Delete adaptive release rule criterion">
...
<Accordion title="Delete course content group by id">
...
<Accordion title="Delete user criterion from course content rule">
...
<Accordion title="Delete lti domain by id">
...
<Accordion title="Delete course content attachment">
...
<Accordion title="Delete category by type and id">
...
<Accordion title="Delete user course meetings">
...
<Accordion title="Delete user from course meetings">
...
<Accordion title="Delete course meeting">
...
<Accordion title="Delete gradebook period by course id">
...
<Accordion title="Delete institution node admin">
...
<Accordion title="Delete calendar item by type and id">
...
<Accordion title="Delete user from institutional node">
...
<Accordion title="Delete course grade notation by id">
...
<Accordion title="Delete data source by id">
...
<Accordion title="Delete course group by ids">
...
<Accordion title="Delete announcement by id">
...
<Accordion title="Delete course from category list">
...
<Accordion title="Delete course assessment question">
...
<Accordion title="Delete pronoun by id">
...
<Accordion title="Delete course by id">
...
<Accordion title="Delete all records in meeting">
...
<Accordion title="Delete lt i placement by id">
...
<Accordion title="Delete gradebook attempt file">
...
<Accordion title="Delete course rubric">
...
<Accordion title="Delete course message by id">
...
<Accordion title="Delete user observer">
...
<Accordion title="Delete attendance record">
...
<Accordion title="Delete rubric association">
...
<Accordion title="Delete term by termid">
...
<Accordion title="Download course content attachment">
...
<Accordion title="Delete institutional hierarchy node by nodeid">
...
<Accordion title="Delete group in course">
...
<Accordion title="Delete gradebook column by id">
...
<Accordion title="Delete course content by id">
...
<Accordion title="Retrieve user grades for course column">
...
<Accordion title="Delete user from course group">
...
<Accordion title="Retrieve course attempt file">
...
<Accordion title="Delete specific course node">
...
<Accordion title="Delete group set in course">
...
<Accordion title="Update user grade details by course">
...
<Accordion title="Fetch course category by id">
...
<Accordion title="Get gradebook column details">
...
<Accordion title="Delete course content adaptive release rule">
...
<Accordion title="Retrieve course content adaptive release rule criterion">
...
<Accordion title="Fetch user criteria from course content rule">
...
<Accordion title="Fetch gradebook attempt files">
...
<Accordion title="Retrieve user meetings in course">
...
<Accordion title="Retrieve rubric evaluation by association">
...
<Accordion title="Retrieve attempt receipt by id">
...
<Accordion title="Get announcement by id">
...
<Accordion title="List announcements">
...
<Accordion title="Fetch rubric evaluation for group attempt column">
...
<Accordion title="Get course meeting download url">
...
<Accordion title="Fetch calendar item by type and id">
...
<Accordion title="Get course content group details">
...
<Accordion title="Fetch category details by id">
...
<Accordion title="Retrieve category type details">
...
<Accordion title="Retrieve course content groups">
...
<Accordion title="Get course content adaptive release group criteria">
...
<Accordion title="Fetch learning session data">
...
<Accordion title="Get course meetings">
...
<Accordion title="Retrieve grade attempt by course and column id">
...
<Accordion title="Get calendar items">
...
<Accordion title="Retrieve course content by ids">
...
<Accordion title="Retrieve gradebook attempts">
...
<Accordion title="Retrieve course role by role id">
...
<Accordion title="Get course resource children">
...
<Accordion title="Fetch course roles information">
...
<Accordion title="Get course gradebook logs">
...
<Accordion title="Get data source by id">
...
<Accordion title="Retrieve course content release criteria">
...
<Accordion title="Get course gradebook group attempts">
...
<Accordion title="Get course resource">
...
<Accordion title="Fetch data source list">
...
<Accordion title="Retrieve course child details">
...
<Accordion title="Retrieve coursediscussion details">
...
<Accordion title="Retrieve user gradebook column">
...
<Accordion title="List child courses for a given course">
...
<Accordion title="Fetch gradebook column logs">
...
<Accordion title="Get attendance record">
...
<Accordion title="List gradebook columns for users">
...
<Accordion title="Get last changed grade column for user">
...
<Accordion title="Get cross list set by course id">
...
<Accordion title="Get course discussion threads">
...
<Accordion title="Retrieve user sessions by user id">
...
<Accordion title="Retrieve course alignments by id">
...
<Accordion title="Retrieve contentcollection resource">
...
<Accordion title="Get attendance records by meeting id">
...
<Accordion title="Retrieve course contents">
...
<Accordion title="Retrieve children goals by id">
...
<Accordion title="Retrieve catalog category children">
...
<Accordion title="Get course meeting details">
...
<Accordion title="Retrieve users from course">
...
<Accordion title="Retrieve course content children">
...
<Accordion title="Get discussion messages for course">
...
<Accordion title="Retrieve lti domain listings">
...
<Accordion title="Fetch goal set category goals">
...
<Accordion title="Retrieve goal set by id">
...
<Accordion title="Get goal set category by id">
...
<Accordion title="Get course content attachment">
...
<Accordion title="Retrieve goal sets">
...
<Accordion title="Retrieve course message folders">
...
<Accordion title="Get gradebook periods by course and period id">
...
<Accordion title="Get system info">
...
<Accordion title="Retrieve course gradebook periods">
...
<Accordion title="List course gradebook columns">
...
<Accordion title="Retrieve course gradebook categories">
...
<Accordion title="Get hierarchy node by node id">
...
<Accordion title="Retrieve lti domain details by domainid">
...
<Accordion title="Get goal alignments by goalid">
...
<Accordion title="Fetch institutional hierarchy nodes">
...
<Accordion title="Retrieves institution role by id">
...
<Accordion title="Retrieve gradebook category by id">
...
<Accordion title="Retrieve course nodes">
...
<Accordion title="Retrieve proctoring services">
...
<Accordion title="Fetch privacy policies">
...
<Accordion title="Retrieve proctoring service by id">
...
<Accordion title="Get user nodes for user id">
...
<Accordion title="List grade notations for course">
...
<Accordion title="Get learning goals">
...
<Accordion title="Retrieve course grade notation">
...
<Accordion title="Get review status of user in course content">
...
<Accordion title="Retrieve courses for institutional node">
...
<Accordion title="List child nodes by node id">
...
<Accordion title="Fetch rubric list for course">
...
<Accordion title="Retrieve participants of course message">
...
<Accordion title="Retrieve discussion message reply">
...
<Accordion title="Retrieve course rubric associations">
...
<Accordion title="Retrieve system role by id">
...
<Accordion title="Get course performance content review status">
...
<Accordion title="Retrieve pronouns information">
...
<Accordion title="Retrieve term by id">
...
<Accordion title="Retrieve rubric association for course">
...
<Accordion title="Get upload settings">
...
<Accordion title="Get gradebook schema for course">
...
<Accordion title="Retrieve sis dataset log by id">
...
<Accordion title="Retrieve goal by id">
...
<Accordion title="Fetch oauth2 tokeninfo">
...
<Accordion title="Get assessment questions by course and assessment id">
...
<Accordion title="List system roles">
...
<Accordion title="Fetch terms list">
...
<Accordion title="Retrieve admin info by nodeid and userid">
...
<Accordion title="Retrieve node admins">
...
<Accordion title="Get course rubric by course id">
...
<Accordion title="Retrieve toc items by course id">
...
<Accordion title="Get rubric associations for gradebook columns">
...
<Accordion title="List institution roles">
...
<Accordion title="Retrieve course resources by id">
...
<Accordion title="Retrieve user avatar by userid">
...
<Accordion title="Get user pronunciation audio">
...
<Accordion title="Retrieve rubric evaluation for attempt">
...
<Accordion title="Retrieve assessment question">
...
<Accordion title="Fetch course task details">
...
<Accordion title="Get institutional node tool information">
...
<Accordion title="Retrieve system version information">
...
<Accordion title="Retrieve gradebook column by course and column ids">
...
<Accordion title="Retrieve course group by ids">
...
<Accordion title="Retrieve users in institutional node">
...
<Accordion title="Retrieve loginas sessions">
...
<Accordion title="Retrieve user in course group">
...
<Accordion title="Fetch goal set categories">
...
<Accordion title="Retrieve gradebook entry for user in course">
...
<Accordion title="List users in course group">
...
<Accordion title="List course group users">
...
<Accordion title="Fetch types of goal sets">
...
<Accordion title="Get group details from course api">
...
<Accordion title="Retrieve rubric evaluation details">
...
<Accordion title="Add course gradebook column">
...
<Accordion title="Modify announcement details">
...
<Accordion title="Create new course with json input">
...
<Accordion title="Retrieve course content adaptive release rules">
...
<Accordion title="Fetch course groups by id">
...
<Accordion title="Retrieve user from course group">
...
<Accordion title="Retrieve user courses by id">
...
<Accordion title="Retrieve course group information">
...
<Accordion title="Patch gradebook column">
...
<Accordion title="Get user course by id">
...
<Accordion title="List course group sets">
...
<Accordion title="Retrieve lti placement by id">
...
<Accordion title="Get content collection resources children">
...
<Accordion title="Retrieve observees of user profile">
...
<Accordion title="Fetch content collection resources">
...
<Accordion title="Get user observers by id">
...
<Accordion title="Fetch messages for course id">
...
<Accordion title="Get courses for category">
...
<Accordion title="Retrieve course group sets">
...
<Accordion title="Fetch lti placements">
...
<Accordion title="Delete child course association">
...
<Accordion title="Obtain oauth2 token via post">
...
<Accordion title="Patch hierarchy node tool settings">
...
<Accordion title="Update category details by type">
...
<Accordion title="Delete discussion message by id">
...
<Accordion title="Post discussion message in course">
...
<Accordion title="Delete gradebook column in course">
...
<Accordion title="Patch grade information for user">
...
<Accordion title="Update attempt status in gradebook">
...
<Accordion title="Patch data source by external id">
...
<Accordion title="Download course gradebook attempt file">
...
<Accordion title="Patch adaptiverelease criterion">
...
<Accordion title="Modify system announcement details">
...
<Accordion title="Patch course content">
...
<Accordion title="Patch calendar item by type and id">
...
<Accordion title="Update attendance record">
...
<Accordion title="Patch course meeting details">
...
<Accordion title="Update course discussion details">
...
<Accordion title="Patch grade notation for course">
...
<Accordion title="Update course group details">
...
<Accordion title="Delete course announcement by id">
...
<Accordion title="Update course group information">
...
<Accordion title="Update discussion message status">
...
<Accordion title="Update grading period info">
...
<Accordion title="Update institution node by id">
...
<Accordion title="Update lti domain configuration">
...
<Accordion title="Update admin node roles">
...
<Accordion title="Retrieve course gradebook column attempts">
...
<Accordion title="Get course gradebook attempt">
...
<Accordion title="Update gradebook column">
...
<Accordion title="Patch course details by id">
...
<Accordion title="Update attendance records">
...
<Accordion title="Patch term details by termid">
...
<Accordion title="Patch course content review status">
...
<Accordion title="Update pronoun status by id">
...
<Accordion title="Update rubric evaluation">
...
<Accordion title="Update course toc item">
...
<Accordion title="Update lti placement details">
...
<Accordion title="Modify user enrollment in course">
...
<Accordion title="Modify assessment question">
...
<Accordion title="Update course primary node status">
...
<Accordion title="Patch course rubric details">
...
<Accordion title="Update course message read status">
...
<Accordion title="Create new uploads">
...
<Accordion title="Update rubric association settings">
...
<Accordion title="Get course groups">
